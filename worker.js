...
async function 生成随机IP(request, count = 16, 指定端口 = -1) {
    const asnMap = { '13238': 'cmcc', '4837': 'cu', '4134': 'ct' }, asn = request.cf.asn;
    const cidr_url = asnMap[asn] ? `https://github.com/xsircn/node-cloudfare/blob/main/${asnMap[asn]}.txt` : 'https://github.com/xsircn/node-cloudfare/blob/main/CF-Others.txt';
    const cfname = { '13238': '移动优选', '4837': '联通优选', '4134': '电信优选' }[asn] || '官方优选';
...
async function nginx() {
	...
	<body>
	<html>
            <head><title>Welcome to xsop</title><style>body { width: 35em; margin: 0 auto; font-family: Tahoma, Verdana, Arial, sans-serif; }</style></head>
            <body><h1>Xsop Share</h1><p>请选择你要访问的站点</p><p>Come To Xsop <a href="https://xsop.de/">Xsop.De</a>.<br/>Come To Node <a href="https://xspeek.de/">Xspeek.de</a>.</p></body>
            </html>
	</body>
	</html>
	`
